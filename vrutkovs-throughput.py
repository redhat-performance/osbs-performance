...
def cmd_start_builds(args):
    ...
    for (i, b) in enumerate(branches):
        ...
        try:
            ...
            run("osbs", "--config", "/home/vrutkovs/src/osbs-client/osbs-beaker.conf", "-i", "osd",
                "build", "-g", remote_url, "-b", b,
                "--target", "extras-rhel-7.2-docker-candidate",
                "-c", "fake-component", "-u", "vrutkovs", "--no-logs", *repo_url)
